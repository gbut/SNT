        ...
        <section class="caseStudies clearfix">
          ...
          <div class="lt">
            ...
            <div id="vidCont">
              ...
              <!-- + Video 2 -->
              <div id="super-catastrophe" class="clearfix ui-tabs-hide" style="width:660px;height:360px;background-color:red;overflow:hidden;"></div>
              <!-- / Video 2 -->

              <!-- + Video 3 -->
              <div id="multi-billion-mystery" class="clearfix ui-tabs-hide" style="width:660px;height:360px;background-color:blue;overflow:hidden;"></div>
              <!-- / Video 3 -->
            </div>
