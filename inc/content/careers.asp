...
<div id="careers">
  ...
  <div id="presenterCont">
    <div id="presenter">
      ...
      <div id="vidOverlay">
        <iframe src="/inc/content/blank.asp" width="626" height="352" scrolling="no" frameborder="0" id="vidFrame"></iframe>
  ...
  <section class="careersHomeIntro clearfix">
    <div class="lt">
      <h4>Entrepreneurial opportunity.<br />Market leader resources.</h4>
