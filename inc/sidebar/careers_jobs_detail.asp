...
-->
    ...
    <script type="text/javascript">
      var addthis_share = { templates: { twitter: '{{title}} {{url}} #rms'}};
      var addthis_config = {
        ...
        services_excplude:      'email, delicious, linkedin, digg, facebook'
      };
    </script>
