...
//===============================================
  ...
  countryData['br'] = {
    ...
    flag: "brazil.png",
    facts: { exposure:["$3.6 Billion",36], population:["19 Million",10], lifeexp:["67 Years",25], landmass:["3,300,105",11] },
    perils: ['all','windstorms','terrorism']
  };
  countryData['ar'] = {
    name: "Argentina",
    ...
    flag: "argentina.png",
    facts: { exposure:["$14.6 Billion",17], population:["11.4 Million",20], lifeexp:["68.3 Years",22], landmass:["2,717,129",26] },
    perils: ['all','winterstorms','fire']
  };
  countryData['co'] = {
    name: "Colombia",
